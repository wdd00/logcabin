...
class MessageSocket {
  public:
    ...
    /**
     * The resources of RDMA connection, including IB device context, meomory region, queue pair, completion queue and protection domain.
     */ 
    ...
    /**
     * THe buffer related with the registered memory region and save the message to be sent.
     */ 
    char *buf;
     ...
     *      receive longer messages will disconnect the socket.
     * \param address
     *	    Include the resources necessary for RDMA connection.
     * \param remote_props
     *      Save the information about the remote server.
     * \param buf
     *      Buffer related with the registered memory region of RDMA connection and save the message to be sent.
     */
    MessageSocket(Handler& handler,
                  Event::Loop& eventLoop,
                  int fd,
